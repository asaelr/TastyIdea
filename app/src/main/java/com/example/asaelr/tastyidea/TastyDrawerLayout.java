    ...
    private enum ITEMS
    {
        SEARCH {
            ...
            public void handleSelection(TastyDrawerLayout drawer) {
                ...
                drawer.activity.startActivity(new Intent(drawer.activity, SearchActivity.class));
        ...
        MY_RECIPES {
            ...
            @Override
            public void handleSelection(TastyDrawerLayout drawer) {
                if(drawer.activity instanceof RecipesListActivity) return;
                drawer.activity.startActivity(new Intent(drawer.activity, RecipesListActivity.class));
                drawer.activity.finish();
            }
        },
        FAVORITES {
        ...
        ADD_RECIPE {
            ...
            public void handleSelection(TastyDrawerLayout drawer) {
                ...
                drawer.activity.startActivity(new Intent(drawer.activity, AddRecepieActivity.class));
                drawer.activity.finish();
            }
        },
        PREFERENCE {
            ...
            public void handleSelection(TastyDrawerLayout drawer) {
                ...
                drawer.activity.startActivity(new Intent(drawer.activity, SettingsActivity.class));
                drawer.activity.finish();
            }
        },
        LOGIN {
